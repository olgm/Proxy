...
//
// V says what a release is called. It cannot say what is on a node — a constant
// can go unchanged across many commits — so String() also reports the commit
// the binary was built from, which Go stamps into anything built inside the
// work tree. The two answer different questions: V is the name a release was
